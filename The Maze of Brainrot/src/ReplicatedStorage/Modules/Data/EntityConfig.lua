...
EntityConfig.Entities = {
    GlitchingGuard = {
        ...
        Speed = 19, -- Slightly faster chaser
        Description = "Patrols a fixed path. Lethal on contact.",
        BehaviorType = "Chase", -- Re-assigning to Chase based on 'Chaser (Guard)' request, or keep Patrol? Request says 'Chaser (Guard)'.
        -- Wait, Request says: "The 'Chaser' (Guard)", "The 'Stalker' (Worker)", "The 'Camera' (Mannequin)".
        -- So Guard = Chase, Worker = Stalker, Mannequin = Camera.
        Color = Color3.fromRGB(200, 50, 50),
        BodyScale = 1.2,
        SoundId = "rbxassetid://9118026602", -- Radio Static
        SoundVolume = 0.6,
        SoundMaxDistance = 60,
        DetectionRange = 60,
        KillRange = 5,
    ...
    FacelessWorker = {
        ...
        BodyScale = 1.0,
        SoundId = "rbxassetid://9126112626", -- Deep Humming
        SoundVolume = 0.4,
        SoundMaxDistance = 40,
        DetectionRange = 55,
        KillRange = 5,
        ...
        StalkGap = 30,             -- Request: 30 stud distance
        RushSpeedMultiplier = 2.5, -- Request: Speed 25 (Sprint Mode). Base is 10, so 2.5x
    },
    ...
    ScurryingShadow = {
        ...
        BodyScale = 0.8,
        SoundId = "rbxassetid://9126281397", -- Skitter
        SoundVolume = 0.8,
        SoundMaxDistance = 50,
        DetectionRange = 50,
        KillRange = 4,
    ...
    MuteMannequin = {
        ...
        BodyScale = 1.1,
        SoundId = "rbxassetid://114181526780038", -- Heavy Footsteps
        SoundVolume = 0.9,
        SoundMaxDistance = 30,
        DetectionRange = 999,
        KillRange = 5,
    ...
    RustedJanitor = {
        ...
        BodyScale = 1.3,
        SoundId = "rbxassetid://9113849445", -- Key Jingle
        SoundVolume = 0.7,
        SoundMaxDistance = 55,
        DetectionRange = 40,
        KillRange = 6,
